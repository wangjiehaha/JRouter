...
class StubServiceGenerator implements IServiceGenerator {
    ...
    def static final DISPATCHER_SERVICE = 'com.jwhaha.jrouter.api.ipclib.dispatcher.DispatcherService'
    def static final DISPATCHER_PROVIDER = 'com.jwhaha.jrouter.api.ipclib.dispatcher.DispatcherProvider'
