package com.jwhaha.jrouter.plugin;
...
import static com.jwhaha.jrouter.annotation.Const.GEN_PKG;
import static com.jwhaha.jrouter.annotation.Const.GEN_PKG_SERVICE;
import static com.jwhaha.jrouter.annotation.Const.INIT_METHOD;

public class JRouterTransform extends Transform {

    private static final String NAME = "JRouter";
    private static final String SERVICE_LOADER_INIT = GEN_PKG + ".ServiceLoaderInit";

    private static final String INIT_SERVICE_DIR = GEN_PKG_SERVICE.replace('.', File.separatorChar);
    private static final String INIT_SERVICE_PATH = GEN_PKG_SERVICE.replace('.', '/');
    ...
    public void transform(TransformInvocation invocation) {
        ...
        File dest = invocation.getOutputProvider().getContentLocation(
                NAME, TransformManager.CONTENT_CLASS,
    ...
    /**
     * 扫描由注解生成器生成到包 {@link ##GEN_PKG_SERVICE} 里的初始化类
     */
    ...
    private void generateServiceInitClass(String directory, Set<String> classes) {
        ...
        try {
            ...
            String className = SERVICE_LOADER_INIT.replace('.', '/');
